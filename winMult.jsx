...
class Win extends Component {
    ...
    render() { 
        return (
        <div className='main-bg-mult-win main-bg-allx'>
            <div className='still still-mult still-sized'>
                <h1 className="win-head">Congratulations!</h1>
                <h2 className="win-head2">You are a hero in multiplying two numbers</h2>
            ...
            <a className="ref" style={{top: "130%"}} href='https://www.freepik.com/vectors/space-game'>Space game vector created by upklyak - www.freepik.com</a>
            </div>
        );
    }
}
