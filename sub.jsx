...
import Win from './winSub';
import Lose from './loseSub'
...
class Sub extends Component {
    constructor(props) {
      super(props);
      this.state = {
        message: "Let's test your subtraction skill!",
        index: 0,
    ...
    renderStill() {
      return (
        <div className='main-bg-sub main-bg-all'>
          <div className='still still-sub'>
          ...
          <a className="ref" href='https://www.freepik.com/vectors/neon-city'>Neon city vector created by vectorpocket - www.freepik.com</a>
        </div>
      );
    }
